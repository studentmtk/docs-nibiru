...
- [dex - proto](#dex---proto)
  ...
  - [dex/v1/genesis.proto](#dexv1genesisproto)
    - [GenesisState](#genesisstate)
  - [dex/v1/params.proto](#dexv1paramsproto)
    - [Params](#params)
  - [dex/v1/pool.proto](#dexv1poolproto)
    - [Pool](#pool)
    - [PoolAsset](#poolasset)
    - [PoolParams](#poolparams)
  - [dex/v1/query.proto](#dexv1queryproto)
    - [QueryExitExactAmountInRequest](#queryexitexactamountinrequest)
    - [QueryExitExactAmountInResponse](#queryexitexactamountinresponse)
    - [QueryExitExactAmountOutRequest](#queryexitexactamountoutrequest)
    - [QueryExitExactAmountOutResponse](#queryexitexactamountoutresponse)
    - [QueryJoinExactAmountInRequest](#queryjoinexactamountinrequest)
    - [QueryJoinExactAmountInResponse](#queryjoinexactamountinresponse)
    - [QueryJoinExactAmountOutRequest](#queryjoinexactamountoutrequest)
    - [QueryJoinExactAmountOutResponse](#queryjoinexactamountoutresponse)
    - [QueryNumPoolsRequest](#querynumpoolsrequest)
    - [QueryNumPoolsResponse](#querynumpoolsresponse)
    - [QueryParamsRequest](#queryparamsrequest)
    - [QueryParamsResponse](#queryparamsresponse)
    - [QueryPoolNumberRequest](#querypoolnumberrequest)
    - [QueryPoolNumberResponse](#querypoolnumberresponse)
    - [QueryPoolParamsRequest](#querypoolparamsrequest)
    - [QueryPoolParamsResponse](#querypoolparamsresponse)
    - [QueryPoolRequest](#querypoolrequest)
    - [QueryPoolResponse](#querypoolresponse)
    - [QueryPoolsRequest](#querypoolsrequest)
    - [QueryPoolsResponse](#querypoolsresponse)
    - [QuerySpotPriceRequest](#queryspotpricerequest)
    - [QuerySpotPriceResponse](#queryspotpriceresponse)
    - [QuerySwapExactAmountInRequest](#queryswapexactamountinrequest)
    - [QuerySwapExactAmountInResponse](#queryswapexactamountinresponse)
    - [QuerySwapExactAmountOutRequest](#queryswapexactamountoutrequest)
    - [QuerySwapExactAmountOutResponse](#queryswapexactamountoutresponse)
  - [### QueryTotalLiquidityRequest](#-querytotalliquidityrequest)
    - [QueryTotalLiquidityResponse](#querytotalliquidityresponse)
  - [### QueryTotalPoolLiquidityRequest](#-querytotalpoolliquidityrequest)
    - [QueryTotalPoolLiquidityResponse](#querytotalpoolliquidityresponse)
    - [QueryTotalSharesRequest](#querytotalsharesrequest)
    - [QueryTotalSharesResponse](#querytotalsharesresponse)
    - [Query](#query)
  - [dex/v1/tx.proto](#dexv1txproto)
    - [EventAssetsSwapped](#eventassetsswapped)
    - [EventPoolCreated](#eventpoolcreated)
    - [EventPoolExited](#eventpoolexited)
    - [EventPoolJoined](#eventpooljoined)
    - [MsgCreatePool](#msgcreatepool)
    - [MsgCreatePoolResponse](#msgcreatepoolresponse)
    - [MsgExitPool](#msgexitpool)
    - [MsgExitPoolResponse](#msgexitpoolresponse)
    - [MsgJoinPool](#msgjoinpool)
    - [MsgJoinPoolResponse](#msgjoinpoolresponse)
    - [MsgSwapAssets](#msgswapassets)
    - [MsgSwapAssetsResponse](#msgswapassetsresponse)
    - [Msg](#msg)
